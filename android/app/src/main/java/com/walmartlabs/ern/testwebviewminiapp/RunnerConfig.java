package com.walmartlabs.ern.testwebviewminiapp;

import com.walmartlabs.ern.container.miniapps.TestwebviewMiniappActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = TestwebviewMiniappActivity.class;
